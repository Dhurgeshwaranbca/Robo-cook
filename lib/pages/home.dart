...
import 'package:fitness/pages/categoryList.dart';
              ...
              child: ElevatedButton(
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => categoryList(
                        buttonName: categories[index].name,
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(16), // Match container borderRadius
                  ),
                ),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    ClipOval(
                      child: SizedBox(
                        width: 50,
                        height: 50,
                        child: _buildCategoryIcon(categories[index].iconPath),
                      ),
                    ),
                    Text(
...
Widget _buildCategoryIcon(String iconPath) {
  ...
  if (iconPath.endsWith('.svg')) {
    ...
    return Icon(Icons.error);  // Return an error icon if the format is not supported
  }
}